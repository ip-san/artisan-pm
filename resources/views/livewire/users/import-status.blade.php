...
<div class="max-w-2xl">
    <h1 class="text-xl font-semibold text-gray-900 mb-6">ユーザーCSVインポート状況</h1>
    ...
    <div wire:poll.2s="refresh" class="rounded-md border border-gray-200 bg-white p-4">
        ...
        @if ($import->status->isFinished())
            <a href="{{ route('users.index') }}" class="mt-4 inline-block rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500">ユーザー一覧へ</a>
        @endif
    </div>
</div>
