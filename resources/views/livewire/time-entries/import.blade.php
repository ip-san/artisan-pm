...
<div class="max-w-2xl">
    <h1 class="text-xl font-semibold text-neutral-900 mb-6">{{ $project->name }} — 工数CSVインポート</h1>
    ...
    <form wire:submit="startImport" class="space-y-4">
        ...
        @if ($headers !== [])
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('time-entries.index', $project) }}" class="rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50">
                    キャンセル
                </a>
            </div>
        @endif
