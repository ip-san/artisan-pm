...
<div class="max-w-2xl">
    ...
    <h1 class="text-xl font-semibold text-neutral-900 mb-2">コミッターのマッピング</h1>
    ...
    <form wire:submit="addMapping" class="mb-6 flex items-end gap-2 rounded-md border border-neutral-200 bg-white p-4">
        <div class="flex-1">
            <label class="block text-sm font-medium text-neutral-700">コミッター文字列</label>
    ...
    <ul class="divide-y divide-neutral-200 rounded-md border border-neutral-200 bg-white">
        ...
        @empty
            <li class="px-4 py-6 text-sm text-neutral-500">対応付けがありません。</li>
        @endforelse
    </ul>
</div>
