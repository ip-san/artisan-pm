...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * Overridden from the package's own default (false) — with
         * subsetting off, embedding a full CJK face like IPAGothic (which
         * covers thousands of glyphs the PDF never uses) for issue export
         * inflated a one-page PDF to ~8.9MB (measured empirically, see
         * docs/parity-checklist.md's PDF出力 entry); with it on, only the
         * glyphs actually printed are embedded.
         */
