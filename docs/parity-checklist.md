...
**現状(2026-07-24): Issues/Versions/Groups/Roles/Trackers/Issue statuses/Issue categories/Issue relations/Enumerations/Memberships/Watchers/添付アップロードが実装済み、Projectsはindex/showのみ**。Redmineは ~20 リソース群を公開、残りはUsers/Time entries/News/Custom fields/Wiki pages/Queries/Journals/Search/My accountが未実装。
